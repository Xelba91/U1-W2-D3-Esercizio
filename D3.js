...
console.log("Esercizio 6: Massa totale: ", crewMass);
/* ESERCIZIO 7
...
*/
// for (let i = 0, let j = 0; i < charactersNames.length; i++) {
...
// if (femaleCharacters[0].name === charactersNames[4]) {
//   delete charactersNames[4];
//   console.log(charactersNames);
// }

// console.log(femaleCharacters.length);
// console.log(starWarsCharacters[1]);
// console.log("Character", charactersNames[4]);
// console.log(femaleCharacters[0].name === charactersNames[4]);
